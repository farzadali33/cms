    ...
    resources: {
      en: {
        translations: {
          ...
          "Sales performance of all states in the world":
            "Sales performance of all states in the world",
          ...
          "A comparison of people who mark themselves of their ineterest =require( the date range given above. Learn more.":
            "A comparison of people who mark themselves of their ineterest =require( the date range given above. Learn more.",
      ...
      ar: {
        translations: {
          ...
          "How are your active users trending overtime?":
            "كيف هي اتجاه المستخدمين النشطين مع مرور الوقت؟",
          ...
          "Sales performance of all states in the world":
            "أداء المبيعات لجميع الدول في العالم",
          "This is your most recent earnings for today's date.":
            "هذا هو أحدث أرباحك لتاريخ اليوم.",
          Activations: "التنشيط",
          Updated: "محدث",
          ...
          "A comparison of people who mark themselves of their ineterest =require( the date range given above. Learn more.":
            "مقارنة بين الأشخاص وفقًا للنطاق الزمني الموضح أعلاه. تعرف أكثر.",
          ...
          "Copyright © 2019 Stellar. All rights reserved.":
            "حقوق الطبع والنشر © 2019 Stellar. كل الحقوق محفوظة.",
        },
      },
    },
    fallbackLng: "en",
